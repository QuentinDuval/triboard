(defproject triboard "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "triboard.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main triboard.server
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                :compiler {:main triboard.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/triboard.js"
